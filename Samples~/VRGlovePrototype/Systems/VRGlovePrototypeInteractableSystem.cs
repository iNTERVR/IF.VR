...
using Inter.VR.VRGlovePrototype.Components;

namespace Inter.VR.VRGlovePrototype.Systems
{
    public class VRGlovePrototypeInteractableSystem : ISetupSystem, ITeardownSystem
    {
        public IGroup Group => new Group(typeof(InterVRInteractable), typeof(VRGlovePrototypeInteractable), typeof(ViewComponent));
        ...
        public VRGlovePrototypeInteractableSystem(
        ...
        public void Setup(IEntity entity)
        {
            ...
            var vrPrototypeInteractable = entity.GetComponent<VRGlovePrototypeInteractable>();
