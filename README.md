![IMG](https://img.shields.io/badge/pkg%20name-com.intervr.unity.extern.steamvr-yellowgreen?style=for-the-badge&logo=appveyor)

![NPM](https://img.shields.io/npm/v/com.intervr.unity.extern.steamvr)
![NPM](https://img.shields.io/npm/l/com.intervr.unity.extern.steamvr)

# 소개

SteamVR은 iNTERVR의 외부 [ValveSoftware]에서 [유니티]를 기반으로 하여 제작된 소프트웨어 개발 도구(SDK)입니다.
...
* 또는, [ValveSoftware]의 릴리즈를 통해 직접 최신 버전을 받아서 설치합니다.
...
* [프로젝트-메니패스트]인 `manifest.json`을 수정하기 위해 텍스트 편집기에서 오픈합니다.
 ...
 ![NPM](https://img.shields.io/npm/v/com.intervr.unity.extern.steamvr)에서 v를 제외한 나머지로 자리에 맞추어 대체 되어야 합니다.
```json
{
  "scopedRegistries": [
    {
  ...
  "dependencies": {
    "com.intervr.unity.extern.steamvr":  "X.Y.Z",
    ...
  }
}
```
