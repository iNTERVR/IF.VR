...
namespace InterVR.IF.VR.Modules
{
    ...
    {
        void AttachToHand(IEntity vrHandEntity, IEntity attachEntity, IF_VR_HandGrabTypes grabbedWithType, IF_VR_HandAttachmentFlags flags = IF_VR_HandAttachmentFlags.Default, Transform attachmentOffset = null);
